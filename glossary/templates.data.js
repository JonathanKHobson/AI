...

{
  ...
  return [
    ...
    'Output:\n1) Past card – interpretation and how past events or influences relate to the question\n2) Present card – what it says about the current situation\n3) Future card – guidance or probable outcome\n(Each explained in a few sentences tying back to the question.)'
      ...
      meta: {
        search_text: "tarot spread reflection — past · present · future tarot-spread-reflection a three-card spread (often past-present-future) used as a reflective tool. each card’s meaning is applied metaphorically to the user’s question or situation, providing narrative insight and guidance. provide a question or topic you’d like insight on. optionally, list three tarot cards you drew (or let the model pick symbolic ones). the model will interpret each card in relation to your question, covering past influences, present situation, and future guidance. type:framework use:content use:storytelling level:intermediate use:goals use:brainstorming creativity self-reflection gain personal insight by interpreting a situation through symbolic cards use archetypal imagery to brainstorm solutions or perspectives on a problem practice creative storytelling or introspection using a 3-card tarot format even if you don’t know tarot meanings, focus on the imagery or themes each card suggests and how it might relate to your life. if a card interpretation feels negative, include an empowering reframe or advice to balance it. question or situation for guidance drawn cards (optional, one per line)"
      }
    },
